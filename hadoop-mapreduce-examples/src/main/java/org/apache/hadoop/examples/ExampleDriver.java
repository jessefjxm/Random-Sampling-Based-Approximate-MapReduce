...
public class ExampleDriver {
	...
	public static void main(String argv[]) {
		...
		try {
			pgd.addClass("randcharcount", RandomizedCharacterCount.class,
					"An randomized map/reduce program that counts the characters in the input files.");
			pgd.addClass("randwordcount", RandomizedWordCount.class,
					"An randomized map/reduce program that counts the words in the input files.");
			pgd.addClass("randapachelog", RandomizedApacheLogAnalysis.class,
					"An randomized map/reduce program that analysis apache log.");
			pgd.addClass("randwireless", RandomizedWirelessLogAnalysis.class,
					"An randomized map/reduce program that analysis wireless log.");
			...
			pgd.addClass("wordstandarddeviation", WordStandardDeviation.class,
					"A map/reduce program that counts the standard deviatio		n of the length of the words in the input files.");
